...
export default function Home() {
  return (
    <div>
      <Navbar />
      <div className='first md:px-32 sm:px-1 shadow-lg  '>
      ...
      <div className='bg-black py-10'>
        ...
        <div className="border-[2px] text-white border-white hover:text-black hover:bg-white transition-all 2s ease-in lg:mx-[25%] md:mx-[15%] sm:mx-10 rounded-3xl mt-5 ">
          <div className="p-8 ">
        ...
        <div className="border-[2px] border-white hover:text-black hover:bg-white transition-all 2s ease-in text-white lg:mx-[25%] md:mx-[15%] sm:mx-10 rounded-3xl mt-5 ">
          <div className="p-8 ">
            <div className="flex justify-between items-center ">
              <h1 className='text-[22px]  font-semibold '>How do I place an order for delivery?</h1>
              <h1 className='text-[rgb(236,8,8)] text-5xl font-bold pr-10'>+</h1>
      ...
      <div className="">
        ...
        <div className="bg-[rgb(236,8,8)] lg:m-24 md:m-12 sm:m-4 lg:p-16 md:p-10 sm:p-5 rounded-[50px] relative overflow-hidden">
          <h1 className="text-[55px] font-bold py-8 text-white text-center z-10">Join our mailing list for updates</h1>
          <input type="email" className='py-4 px-12 text-center rounded-full border-none z-20 relative lg:w-[700px] sm:w-[90%] md:w-[70]  flex mx-auto text-xl font-semibold' placeholder='Enter Your Email' />
          <button className=' bg-white py-3  px-9 rounded-[30px] hover:scale-105 text-black relative z-10
         font-bold flex mx-auto my-10  '>Subscribe Now</button>
          <Image src='/foodbag.png' className='absolute bottom-0 right-1 z-0  w-[150px] md:w-[225px] h-auto' width={225} height={337} alt='pic' />
        </div>
